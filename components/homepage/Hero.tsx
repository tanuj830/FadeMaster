...
const Hero = () => {
  return (
    <div className="relative  py-10 px-[6vw] lg:px-[10vw] h-[85vh] ">
      <div className="flex  justify-between items-center h-full w-full lg:w-[50vw]">
        ...
        <div className="flex justify-center  flex-col items-center lg:items-start">
          <h1 className=" text-center  font-[600] text-primary/90 leading-10 lg:leading-[80px] md:text-[4rem] text-[2.2rem] ">
            Vocal Remover and Isolation with
          </h1>
          {/* <h1 className="text-[#0000ff] font-[600] text-center text-[2rem] lg:pl-20 md:text-[4rem]">
            Your Carrer
          </h1> */}
          <h1 className="font-bold text-primary leading-10 lg:leading-[80px] text-center text-[2.2rem] md:text-[4rem]">
            Fade Master.
          </h1>
          <p className="py-10 text-lg text-center lg:text-start text-muted-foreground font-medium">
            ...
            algorithms. Free editor to trim and cut any audio file online.
          </p>
